...
**Version:** 3.2.53 | **Node.js:** ≥24 | **License:** Private

### Key Features

#### AI & LLM Support
- **Multi-Provider LLM Support** - Azure AI, OpenAI, Anthropic, Google Gemini, xAI (Grok), DeepSeek, Perplexity, Mistral, Cohere, Groq, AWS Bedrock, Ollama, Fireworks AI, Together AI, DeepInfra
...
- **Image Generation** - Dedicated image model endpoints (Azure AI / OpenAI `gpt-image-1`, xAI `grok-2-image`, Gemini image models) power the `generate_image` chat tool
